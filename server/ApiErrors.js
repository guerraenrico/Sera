...
const Unauthorized = () =>
  getError(ErrorCodes.UNAUTHORIZED, "Unauthorized", "Invalid token");
const ExpiredSession = () =>
  getError(ErrorCodes.EXPIRED_SESSION, "ExpiredSession", "Expired session");

const ErrorAuthInvalidPayload = () =>
  getError(
    ErrorCodes.AUTH_INVALID_PAYLOAD,
    "Invalid payload",
    "Something is wrong with your payload. Please retry!"
  );
const ErrorAuthInvalidCode = () =>
  getError(
...
const InvalidAuthCode = () =>
  getError(
    ...
    "Parameter code non provided",
    "Invalid request. You can do nothing about it"
  );
const InvalidCategoryParameters = () =>
  getError(
